...
function Purchase_return() {
  const [activeTab, setActiveTab] = useState("return_entry");
  ...
  return (
    <div className="container-fluid sale p-3 bg-white">
        ...
        <div className="row">
          <div
            ...
            className={`col-md-2 saletabdiv ${
              activeTab === "return_entry" ? "active" : ""
            }`}
            onClick={() => handleTabClick("return_entry")}>
            <p>Return Entry</p>
          </div>
          <div
            role="button"
            className={`col-md-2 saletabdiv ${
              activeTab === "find_return" ? "active" : ""
            }`}
            onClick={() => handleTabClick("find_return")}>
            <p>Find Return</p>
          </div>
        </div>
      </div>
      {activeTab === "return_entry" && (
        <div id="return_entry">
          <div className="row p-3">
            ...
            <div className="col-md-3 field_div">
              ...
              <input type="date" placeholder="Shipment Date" />
            </div>
            <div className="col-md-3 field_div">
              <label>GE Date</label>
      ...
      {activeTab === "find_return" && (
        <div id="find_return" className="p-5">
